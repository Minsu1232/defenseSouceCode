...
public class PrimevalWarriorSkill : Skill
{
    ...
    {  
        ...
        if (skillBehavior != null)
        {
            ...
            skillBehavior.Initialize(caster, skillDamage, skillRange, targetPosition, chosenDropPoint.gameObject, false, hasSlowEffect, slowAmount, hasDefenseReduction, defenseReductionAmount, true, 15f, 20f);
